...
//             $sql = "INSERT INTO student_list (school_id, firstname, lastname, email, password, class_id, avatar, date_created) VALUES ('" . implode("','", $data) . "')";
        ...
        if ($fileType == "csv") {
            ...
            if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
                ...
                while (($data = fgetcsv($file, 1000, ",")) !== FALSE) {
                    ...
                    $existingRowQuery = $conn->prepare("SELECT COUNT(*) FROM student_list WHERE email = ?");
